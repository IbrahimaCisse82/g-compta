...
export const ACTIF: MapLine[] = [
  ...
  { id: 'AG', label: 'Matériels de transport', c: [['271', '278']], s: 'D' },
  { id: 'AH', label: 'Avances sur immobilisations', c: [['281', '289']], s: 'D' },
  { id: 'T_IC', label: 'TOTAL IMMO. CORPORELLES', type: 'total', refs: ['AC', 'AD', 'AE', 'AF', 'AG'] },
  { id: 'AI', label: 'Titres de participation', c: [['261', '263']], s: 'D' },
  { id: 'AJ', label: 'Autres immobilisations financières', c: [['264', '278']], s: 'D' },
...
export const PASSIF: MapLine[] = [
  ...
  { id: 'CF', label: 'Report à nouveau (+/−)', c: [['131', '139']], s: 'SC' },
  { id: 'CG', label: 'Résultat net (+/−)', c: [['13', '139']], s: 'SC' },
