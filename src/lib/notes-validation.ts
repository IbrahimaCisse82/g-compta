...
export const NOTES_SPEC: NoteSpec[] = [
  ...
  { num: '27B', label: 'Rémunérations dirigeants',          type: 'informative', expectedPrefixes: /(?!)/, expectedRanges: ['Saisie manuelle (nombre, rémunération, indemnités, avantages)'] },
  ...
  { num: '29C', label: 'Gains et pertes de change',         type: 'resultat', expectedPrefixes: /^(476|477|676|776)/,        expectedRanges: ['476/477 — Écarts conv.', '676 — Pertes change', '776 — Gains change'] },
  // Notes 30-34
